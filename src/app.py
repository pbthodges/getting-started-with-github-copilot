...
activities = {
    ...
    "Basketball Club": {
        "description": "Play basketball, improve teamwork, and prepare for games",
    ...
    "Drama Club": {
        "description": "Create performances, rehearse scenes, and stage productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["olivia@mergington.edu", "alex@mergington.edu"]
    }
}
